<footer class="bg-white" aria-labelledby="footer-heading">
    @if(false)
        ...
        <div class="_max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            ...
            <div class="mt-12 border-t border-gray-200 pt-8">
                <p class="text-base text-gray-400 text-center">&copy; {{ \Carbon\Carbon::now()->year }} pluggamatte.se</p>
            </div>
        </div>
</footer>
